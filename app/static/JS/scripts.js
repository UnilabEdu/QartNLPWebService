const loginButton = document.getElementById('logmein')
const loginPopup = document.getElementById('hiddenLogin')

loginButton.addEventListener('click', function alertMe(){
